"""
Excel Assistant Pipe Function for Open-WebUI (Kubernetes)
...
This version is configured for Kubernetes deployment with internal DNS.
"""
...
class Pipe:
    ...
    class Valves(BaseModel):
        ...
        MCP_BASE_URL: str = Field(
            default="http://excel-mcp-service.excel-mcp.svc.cluster.local:8000",
            description="Base URL of the Exel MCP server (internal DNS)"
        )
