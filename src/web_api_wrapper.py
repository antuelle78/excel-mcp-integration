...
class MCPClient:
    ...
    def create_excel_file(self, filename, headers, sheet_data, sheet_name="Sheet1"):
        ...
        if not filename or not headers or not sheet_data:
            return {"error": "Missing required parameters: filename, headers, sheet_data"}
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if json_data:
                    ...
                    if 'result' in result:
                        return {"success": True, "message": "Excel file created successfully", "data": result}
    ...
    def get_excel_info(self, filename):
